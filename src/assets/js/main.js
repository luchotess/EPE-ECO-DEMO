...
(function ($) {
  ...
  var Porto = {
    ...
    owlCarousels: function () {
      ...
      var sliderCustomOptionsArray = {
        ...
        ".cursos-slider": {
          ...
          dots: !1,
          items: 2,
          responsive: {320: {items: 1}, 576: {items: 1}, 992: {items: 2}, 1200: {items: 4}, 1400: {items: 4}}
        },
        ".cursos-baby-slider": {
          loop: true,
          autoplay: false,
          ...
          dots: !1,
          items: 2,
          responsive: {320: {items: 1}, 576: {items: 1}, 992: {items: 2}, 1200: {items: 2}, 1400: {items: 2}}
        },
        ".servicios-slider": {
          loop: true,
          margin: 20,
        ...
        '.product-single-default .product-single-carousel': {
          ...
          onInitialized: function () {
            ...
            if ($.fn.elevateZoom) {
              $source.find('.zoom').each(function () {
                var $this = $(this),
                  zoomConfig = {
                    responsive: true,
    ...
    retrictionsPopup: function () {

    },
    emptyProductsPopup: function () {
